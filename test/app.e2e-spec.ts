...
describe('AppController (e2e)', () => {
  ...
  describe(gql, () => {
    describe('market information', () => {
      it('should get the theta and theta fuel market information', () => {
    ...
    describe('smart contract statistics', () => {
      it('should get the smart contract statistics rank by call times', () => {
        return request(app.getHttpServer())
          .post(gql)
          .send({
            query:
    ...
    describe('stake statistics', () => {
      it('should get the stake statistics', () => {
        return request(app.getHttpServer())
          .post(gql)
          .send({
            query:
